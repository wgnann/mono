...
\title{
    ...
    titlept={Lei n{\textordmasculine } 14.133 e o Registro de Preços},
    titleen={},
...
\newcommand{\bbeta}{\beta^{-1}(b)}
\newcommand{\dinvbeta}{\beta'(\beta^{-1}(b))}
...
\input{conteudo/01-revisao}
\input{conteudo/02-14133}
\input{conteudo/03-modelo}
\input{conteudo/04-conclusoes}
