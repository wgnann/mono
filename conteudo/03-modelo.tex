...
A hipótese simplificadora será a de que o órgão público demandará apenas um único bem, assim como no modelo apresentado por \citetitle{Bugarin2022}. Contudo, como na Lei n{\textordmasculine} 14.133 só admite menor preço ou maior desconto, o modelo de pregão é o de lances sucessivos e, portanto, melhor modelado por um pregão de segundo menor preço.
...
\subsection{Independência do preço}
\subsection{Dependência do preço}
